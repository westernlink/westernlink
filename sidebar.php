  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
   	<a href="javascript:void(0)" class="brand-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
        ...
        <?php else: ?>
          <span class="image">
            <img src="../assets/uploads/profile.jpg" style="width: 38px;height:38px" class="img-circle elevation-2" alt="western link">
          </span>
        <?php endif; ?>
      ...
      <div class="dropdown-menu" style="">
        <a class="dropdown-item manage_account" href="" data-id="<?php echo $_SESSION['login_id'] ?>">Western Link</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="ajax.php?action=logout">Logout To Secure Account</a>
      </div>
    </div>
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <a href="http://localhost/osrs/School%20Fees%20Payment%20Sys%20PHP/School_Fees_System/" class="nav-link nav-classes">
              <i class="nav-icon fas fa-th-list">    Fees Collection</i>
         </a>     
          <a href="Kids Palace/Login - Kids Palace/index.php" class="nav-link nav-classes">
              <i class="nav-icon fas fa-th-list">     Kids Palace</i>
          </a>
